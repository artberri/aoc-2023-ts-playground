import { isNotNil, map, minimum, paragraphs, pipe, without } from "../utils";
...
export default (input: string): string => {
	...
	const getClosestLocation = pipe(
		map(getValue("seed", "location", seedMaps)),
		minimum,
		String,
	);

	return getClosestLocation(seeds);
};
